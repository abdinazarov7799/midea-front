...
const CreateEditWarehouseSections = ({itemData,setIsModalOpen}) => {
    ...
    const onFinish = (values) => {
        if (itemData){
            mutateEdit(
                { url: `${URLS.warehouse_sections_edit}/${get(itemData,'id')}`, attributes: values },
                {
                    onSuccess: () => {
            ...
            mutate(
                { url: URLS.warehouse_sections_add, attributes: values },
                {
                    onSuccess: () => {
                        setIsModalOpen(false);
                    },
