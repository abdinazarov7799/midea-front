...
import CreateEditCouriers from "./components/CreateEditCouriers.jsx";
...
const CouriersContainer = () => {
    ...
    const {data,isLoading} = usePaginateQuery({
        key: KEYS.couriers_list,
        url: URLS.couriers_list,
        params: {
            params: {
                size: 10,
                ...params
    ...
    const useDelete = (id) => {
        mutate({url: `${URLS.couriers_delete}/${id}`})
    }
    ...
    return (
        <Container>
            ...
            <Modal
                ...
                footer={null}
            >
                <CreateEditCouriers setIsModalOpen={setIsCreateModalOpen}/>
            </Modal>
            <Modal
                title={t("Edit")}
