...
const CreateEditWarehouseWorkers = ({itemData,setIsModalOpen}) => {
    ...
    const onFinish = (values) => {
        if (itemData){
            mutateEdit(
                { url: `${URLS.warehouse_workers_edit}/${get(itemData,'id')}`, attributes: values },
                {
                    onSuccess: () => {
            ...
            mutate(
                { url: URLS.warehouse_workers_add, attributes: values },
                {
                    onSuccess: () => {
                        setIsModalOpen(false);
                    },
