...
const CreateEditDealers = ({selected,setIsModalOpen}) => {
    ...
    const onFinish = (values) => {
        ...
        if (selected){
            mutateEdit(
                { url: `${URLS.dealers_edit}/${get(selected,'id')}`, attributes: formData },
                {
                    onSuccess: () => {
            ...
            mutate(
                { url: URLS.dealers_add, attributes: formData },
                {
                    onSuccess: () => {
                        setIsModalOpen(false);
                    },
...
export default CreateEditDealers;
